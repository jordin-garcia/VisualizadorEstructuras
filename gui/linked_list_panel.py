...
from utils.graph_utils import generate_linked_list_graph

class LinkedListPanel(BasePanel):
    """
    Panel para visualizar y manipular listas enlazadas simples.
    """
    ...
    def create_structure(self, data_type):
        """
        Crea una nueva lista enlazada con el tipo de dato especificado.
        
        Args:
            data_type: Tipo de datos para la lista
        """
        self.structure = LinkedList(data_type)
        self._set_controls_enabled(True)
        self.update_info()
        self.update_visualization()
        self.show_message("Estructura Creada", "Se ha creado una nueva lista enlazada vacía.")
    ...
    def update_visualization(self):
        ...
        image_path = generate_linked_list_graph(self.structure)
