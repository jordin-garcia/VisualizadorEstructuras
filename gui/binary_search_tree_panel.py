...
from utils.graph_utils import generate_binary_search_tree_graph

class BinarySearchTreePanel(BasePanel):
    """
    Panel para visualizar y manipular árboles binarios de búsqueda.
    """
    ...
    def _setup_controls(self):
        ...
        self.insert_button = QPushButton("Insertar Valor")
    ...
    def create_structure(self, data_type):
        """
        Crea un nuevo árbol binario de búsqueda con el tipo de dato especificado.
        
        Args:
            data_type: Tipo de datos para el árbol
        """
        self.structure = BinarySearchTree(data_type)
        self._set_controls_enabled(True)
        self.update_info()
        self.update_visualization()
        self.show_message("Estructura Creada", "Se ha creado un nuevo árbol binario de búsqueda vacío.")
    ...
    def remove(self):
        ...
        if success:
            ...
            self.show_error("Error", f"No se pudo eliminar el nodo con valor {value}. Verifique que exista.")
    ...
    def update_visualization(self):
        ...
        image_path = generate_binary_search_tree_graph(self.structure)
